			...
			$.ajax({
				...
				success: function(result) {
					...
					if(result == 1) {
						...
						$('#checkMessage').html('이미 존재하거나 사용할 수 없는 아이디 입니다.');
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						...
						<td style="width: 100px"><button class="btn btn-primary" onclick="registerCheckFunction();" type="button">중복체크</button> </td>
					</tr>				
					<tr>
